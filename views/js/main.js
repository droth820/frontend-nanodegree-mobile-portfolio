...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.src = "images/pizzaMd.png";
...
function resizePizzas(size) { 
  ...
  function determineDx (elem, size) {
    ...
    var dx = (newsize - oldsize) * windowwidth/2;
...
//Amended this function to start variable 'i' at 5
for (var i = 5; i < 100; i++) {
...
function updatePositions() {
  ...
  for (var i = 5; i < items.length; i++) { //changed 'var i' from 0 to 5.
